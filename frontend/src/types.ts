...
export interface ProviderStatus { provider: string; status: 'LIVE' | 'DEGRADED' | 'SYNCING'; lastSuccessfulSync?: string; lastError?: string; dataAgeSeconds?: number; incidentCount: number }
